...
class __Mustache_00d012fbe61c90229d2aebdabd70a2dc extends Mustache_Template
{
...
';
        ...
        $value = $context->find('pix');
        $buffer .= $this->section17dced043cf1f9973e8ce8dcb3301054($context, $indent, $value);
        $buffer .= '<span class="visually-hidden">';
        $value = $context->find('str');
        $buffer .= $this->section2d03965ea53b60ac982e741c28cc2332($context, $indent, $value);
        $buffer .= '</span></div>
';
...
';
        $buffer .= $indent . '                        <i class="fa-solid fa-file-import fa-3x m-auto"></i>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
