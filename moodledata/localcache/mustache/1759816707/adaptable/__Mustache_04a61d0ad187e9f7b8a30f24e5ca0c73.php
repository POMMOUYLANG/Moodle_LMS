...
class __Mustache_04a61d0ad187e9f7b8a30f24e5ca0c73 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF38ed9758f2a0fc7c5fa8cb9d943dea6($context, $indent, $value);
        $value = $context->find('hasformats');
        if (empty($value)) {
...
';
    ...
    private function sectionF38ed9758f2a0fc7c5fa8cb9d943dea6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
