...
class __Mustache_2c7847fe0293b659941f6ad2dbf7559f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockB011b7481ab4b9230631453770fadde7'),
            ));
...
';
    ...
    public function blockB011b7481ab4b9230631453770fadde7($context)
    {
        $indent = $buffer = '';
