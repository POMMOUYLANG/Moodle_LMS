...
class __Mustache_3f15c1f65b7cb2033182e41e5c421c72 extends Mustache_Template
{
...
';
        $value = $context->find('data');
        $buffer .= $this->sectionF5cbdfcc7f18657f3008886d08a1710d($context, $indent, $value);
        $buffer .= $indent . '</div>
';
    ...
    private function section566cdd80414bceb711e852d1116b2e9f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF5cbdfcc7f18657f3008886d08a1710d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section566cdd80414bceb711e852d1116b2e9f($context, $indent, $value);
                $context->pop();
            }
        }
