...
class __Mustache_516b8bb3a2f60d6c3045908acb29efa3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section629f6beb61f379a24762b7c998331f4c($context, $indent, $value);
        $value = $context->find('settingsurl');
        $buffer .= $this->sectionBe4ba2c4cbd3dad631418d766393336b($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
        $value = $context->find('current');
        $buffer .= $this->section175ce2670b93307e334eb9ff792fd020($context, $indent, $value);
        $value = $context->find('current');
        if (empty($value)) {
            
            $value = $context->find('actionurl');
            $buffer .= $this->sectionE2a3bf9de2d85aea7e6b951ea3d5140c($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
...
';
    ...
    private function section629f6beb61f379a24762b7c998331f4c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionBe4ba2c4cbd3dad631418d766393336b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3f829f7acffaddd403b16511fc647226(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section175ce2670b93307e334eb9ff792fd020(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section3f829f7acffaddd403b16511fc647226($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionE2a3bf9de2d85aea7e6b951ea3d5140c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
