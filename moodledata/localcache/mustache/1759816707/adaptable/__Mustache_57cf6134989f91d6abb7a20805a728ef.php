...
class __Mustache_57cf6134989f91d6abb7a20805a728ef extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockA383a4cbca232a683a14c575ce3a6067'),
            ));
...
';
    ...
    private function section959af1730343ae87ffc419600d71dc75(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '<span class="badge bg-info text-white">{{{text}}}</span>';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
    ...
    private function sectionFc89dc6d478e83449b97b7114b49f736(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                ';
                $value = $context->find('selected');
                $buffer .= $this->section959af1730343ae87ffc419600d71dc75($context, $indent, $value);
                $buffer .= '
';
                $context->pop();
            }
    ...
    private function sectionD00702dc7c894cd1902f72de1dab1ac6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionFc89dc6d478e83449b97b7114b49f736($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    public function blockA383a4cbca232a683a14c575ce3a6067($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
...
';
            $buffer .= $indent . '        <select class="form-select ';
...
';
        ...
        $value = $context->findDot('element.frozen');
        $buffer .= $this->sectionD00702dc7c894cd1902f72de1dab1ac6($context, $indent, $value);
