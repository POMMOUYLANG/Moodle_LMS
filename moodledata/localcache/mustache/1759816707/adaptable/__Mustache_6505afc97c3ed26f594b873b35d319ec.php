...
class __Mustache_6505afc97c3ed26f594b873b35d319ec extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockA757400b4393db4981ae3f75e6115376'),
            ));
...
';
    ...
    public function blockA757400b4393db4981ae3f75e6115376($context)
    {
        $indent = $buffer = '';
