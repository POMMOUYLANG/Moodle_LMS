...
class __Mustache_79dc1dbe9a9afd020b8dfa45d3c5993c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF9a9024ab6836e2ce81548d08d4123d7($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function sectionF9a9024ab6836e2ce81548d08d4123d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '    <button id="groupingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="';
                $value = $context->find('str');
