...
class __Mustache_7ef98770bcb872f8e7b9bdf208f3f82c extends Mustache_Template
{
...
';
        ...
        $value = $context->find('header');
        $buffer .= $this->section32550bc528505f94ae6ade1193c803cb($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
        ...
        $buffer .= $this->sectionD80c4c890bb4ff1c823f54c313add2ab($context, $indent, $value);
...
';
    ...
    private function section1c0c4360c90d5dcfd50815facd9ede99(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section32550bc528505f94ae6ade1193c803cb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section1c0c4360c90d5dcfd50815facd9ede99($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionD80c4c890bb4ff1c823f54c313add2ab(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
