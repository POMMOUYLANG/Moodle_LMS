...
class __Mustache_7f1a9f798b509fa0cfeb556b0a8c1e4a extends Mustache_Template
{
...
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-8 d-flex flex-wrap align-items-center pe-0">
';
        $buffer .= $indent . '                        <select class="form-select form-control"></select>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
