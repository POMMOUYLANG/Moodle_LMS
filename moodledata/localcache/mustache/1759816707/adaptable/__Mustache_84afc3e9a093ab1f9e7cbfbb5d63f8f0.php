...
class __Mustache_84afc3e9a093ab1f9e7cbfbb5d63f8f0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="fp-repo-area col-md-3 pe-2 nav nav-pills flex-column" role="tablist">
';
...
';
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '                        <div class="fp-viewbar btn-group float-sm-end">
';
