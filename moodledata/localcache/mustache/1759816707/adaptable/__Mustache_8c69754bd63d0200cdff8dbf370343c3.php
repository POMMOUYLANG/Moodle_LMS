...
class __Mustache_8c69754bd63d0200cdff8dbf370343c3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'containerrole' => array($this, 'blockAd56411833f7d117f5cf7e7217f0c3d4'),
                'containerattributes' => array($this, 'blockAdc868a5418a6d02e3ef1677e6b8de3d'),
                ...
                'headeractions' => array($this, 'block39af5daad306b81af81f3395b754f4a7'),
    ...
    private function section2fd2a31d61eec86a965b2555e3515438(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '               class="btn btn-sm btn-link m-0 py-0 icon-no-margin" >
';
                $buffer .= $indent . '                ';
...
';
    ...
    private function section994b8f5d6e68f8b801322b51753a03c8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'i/window_close';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
...
';
    ...
    public function blockAd56411833f7d117f5cf7e7217f0c3d4($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . 'dialog';
    
        return $buffer;
    }

    public function blockAdc868a5418a6d02e3ef1677e6b8de3d($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block39af5daad306b81af81f3395b754f4a7($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <a class="mark-all-read-button btn btn-sm btn-link m-0 py-0 icon-no-margin"
';
        $buffer .= $indent . '           href="#"
';
        $buffer .= $indent . '           title="';
...
';
        ...
        $buffer .= $this->section2fd2a31d61eec86a965b2555e3515438($context, $indent, $value);
        $buffer .= $indent . '        <button type="button" class="btn btn-sm btn-link m-0 py-0 icon-no-margin" aria-label="';
        $value = $context->find('str');
        $buffer .= $this->section7a20f6a0c1e5f01649c33230170638b5($context, $indent, $value);
        $buffer .= '" title="';
        $value = $context->find('str');
        $buffer .= $this->section7a20f6a0c1e5f01649c33230170638b5($context, $indent, $value);
        $buffer .= '" data-action="close-notification-popover">
';
        $buffer .= $indent . '            ';
        $value = $context->find('pix');
        $buffer .= $this->section994b8f5d6e68f8b801322b51753a03c8($context, $indent, $value);
        $buffer .= '
';
