...
class __Mustache_91fe9bb8ddacc1b0e68234bc358c60e4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAc67c81aa114c93b02868e279c6a4c77($context, $indent, $value);
...
';
    ...
    private function sectionAc67c81aa114c93b02868e279c6a4c77(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '    <div class="hidden" data-region="notification-preference-container" role="group" aria-labelledby="notification-preferences-header-';
                $value = $this->resolveValue($context->find('uniqid'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">
';
                $buffer .= $indent . '        <h3 class="mb-2 mt-4 h6 fw-bold" id="notification-preferences-header-';
                $value = $this->resolveValue($context->find('uniqid'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">';
                $value = $context->find('str');
