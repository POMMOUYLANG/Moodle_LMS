...
class __Mustache_94fdbb0962c53051f1c03d8be1ce929d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block3ed7da5c3dc3e067770ac73e77ba0b7b'),
            ));
...
';
    ...
    public function block3ed7da5c3dc3e067770ac73e77ba0b7b($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
