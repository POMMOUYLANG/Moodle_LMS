...
class __Mustache_95be4cf5b2a80bea84ef3b3030a423b1 extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_lazy_load_list')) {
            $context->pushBlockContext(array(
                ...
                'rootattributes' => array($this, 'block0b93cf8962c21e0631b6b7f65736a206'),
            ));
...
';
    ...
    public function block0b93cf8962c21e0631b6b7f65736a206($context)
    {
        $indent = $buffer = '';
        $buffer .= '            id="';
        $blockFunction = $context->findInBlock('region');
