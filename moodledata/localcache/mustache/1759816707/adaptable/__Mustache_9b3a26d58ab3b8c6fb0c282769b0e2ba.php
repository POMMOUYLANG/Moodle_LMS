...
class __Mustache_9b3a26d58ab3b8c6fb0c282769b0e2ba extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="input-group simplesearchform" role="group" aria-labelledby="messageoverviewgrouplabel">
';
        $buffer .= $indent . '            <span class="visually-hidden" id="messageoverviewgrouplabel">';
