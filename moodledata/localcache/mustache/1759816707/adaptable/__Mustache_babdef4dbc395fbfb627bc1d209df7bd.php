...
class __Mustache_babdef4dbc395fbfb627bc1d209df7bd extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockA83a7843878a68aa3ac1e6ebfc7bd7e4'),
            ));
...
';
    ...
    public function blockA83a7843878a68aa3ac1e6ebfc7bd7e4($context)
    {
        $indent = $buffer = '';
