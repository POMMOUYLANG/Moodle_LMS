...
class __Mustache_bdc8f21e10f8229a1c9df7790d96791a extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <button id="sortingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="';
