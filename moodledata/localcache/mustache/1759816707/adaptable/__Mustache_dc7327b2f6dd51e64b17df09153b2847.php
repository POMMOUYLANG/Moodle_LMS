...
class __Mustache_dc7327b2f6dd51e64b17df09153b2847 extends Mustache_Template
{
...
';
        $value = $context->find('showemojipicker');
        $buffer .= $this->sectionA074d5bc355ccff85396d8c2ac61e109($context, $indent, $value);
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-icon ms-1 mt-auto"
';
        $buffer .= $indent . '            aria-label="';
        $value = $context->find('str');
...
';
    ...
    private function sectionA074d5bc355ccff85396d8c2ac61e109(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            <button
';
                $buffer .= $indent . '                class="btn btn-icon ms-1"
';
                $buffer .= $indent . '                aria-label="';
                $value = $context->find('str');
