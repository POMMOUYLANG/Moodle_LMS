...
class __Mustache_90a0751712b8f59617f6dcbfa5b8c255 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="settingsform adapty">
';
...
';
        ...
        $buffer .= $this->sectionC3fc669804bd7e8bbed8309f0e0e35bd($context, $indent, $value);
...
';
    ...
    private function sectionC3fc669804bd7e8bbed8309f0e0e35bd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    require([\'theme_adaptable/admin_settings\'], function(asettings) {
        asettings.init();
    });
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    require([\'theme_adaptable/admin_settings\'], function(asettings) {
';
                $buffer .= $indent . '        asettings.init();
';
                $buffer .= $indent . '    });
';
                $context->pop();
